...
def main():
    ...
    h5_path = os.path.join("resnetv1_mnist_best.h5")
    if not os.path.exists(h5_path):
        h5_path = os.path.join("resnetv1_mnist_final.h5")
    if not os.path.exists(h5_path):
        raise FileNotFoundError("ResNet .h5 yok. Önce train_resnet_mnist_v1.py çalıştır.")
    ...
    out_path = os.path.join("resnetv1_mnist_int8.tflite")
