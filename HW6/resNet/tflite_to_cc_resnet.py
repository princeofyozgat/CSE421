...
def main():
    ...
    tflite_path = os.path.join("resnetv1_mnist_int8.tflite")
    if not os.path.exists(tflite_path):
        raise FileNotFoundError("resnetv1_mnist_int8.tflite yok. Önce convert scripti çalıştır.")

    var_name = "resnetv1_mnist_int8_model_data"
