...
def labels_to_c(labels, name="mnist_labels_5"):
    lines = []
...
def main():
    ...
    out_path = os.path.join("mnist_samples_5.h")

    content = ""
    content += to_c_array_u8(samples, "mnist_images_5")
    content += labels_to_c(labels, "mnist_labels_5")
