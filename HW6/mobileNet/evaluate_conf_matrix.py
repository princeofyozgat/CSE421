...
def main():
    ...
    # ---- Model yükle ----
    model_path = os.path.join("mobilenet_mnist_best.h5")
    if not os.path.exists(model_path):
        model_path = os.path.join("mobilenet_mnist_final.h5")
    ...
    plt.title("MobileNet MNIST - Confusion Matrix")
    plt.tight_layout()
    plt.show()

    # ---- Kaydet ----
    out_img = os.path.join("mobilenet_confusion_matrix.png")
    plt.savefig(out_img)
