...
def main():
    ...
    # ---- Model yükle ----
    model_path = os.path.join("squeezenet_mnist_best.h5")
    if not os.path.exists(model_path):
        model_path = os.path.join("squeezenet_mnist_final.h5")
    ...
    plt.title("SqueezeNet MNIST - Confusion Matrix")
    plt.tight_layout()
    plt.show()

    # ---- Kaydet ----
    out_img = os.path.join("squeezenet_confusion_matrix.png")
    plt.savefig(out_img)
    print("Confusion matrix kaydedildi:", out_img)
